...
const MovieTheater = () => {
  ...
  return (
    <Grid container direction="column" alignItems="center">
      ...
      >
        <div>
          <span className="square" style={{ marginRight: "30px" }}></span>
      ...
      >
        ...
        >
          <span
            className="square"
            style={{ backgroundColor: "#fb9e61", marginRight: "29px" }}
          ></span>
          Selected Seats -
          {selectedCount < 10 ? ` ${selectedCount} ` : selectedCount}
        </Grid>
        <Grid
          container
          item
        ...
        >
          <span
            className="square"
            style={{ backgroundColor: "#bad1f1", marginRight: "20px" }}
          ></span>
